...
public class AniversarioDao extends GenericDaoHibernate<Aniversario>{
	//este comando  deu certo no sql
			...
			//este método deu certo  no JUnit pega todos que fazem aniversario no dia e mes passado no parametro qualquer ano
			...
			//este método deu certo  no JUnit pega todos que fazem aniversario no mes passado no parametro qualquer ano
			@SuppressWarnings("unchecked")
