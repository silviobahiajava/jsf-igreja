...
public class LancamentoContribuicaoBean {
	...
	public void novo() {
		try {
			...
			// listaOfertas=ofertaDao.buscarOfertaPorGrupo("varões");
...
*/	
	...
	public void calcular() {
		...
		public void adicionarContribuicao(ActionEvent evento){
			...
			//calcular();
			Utils.mostrarMensagemJsfSucesso("A contribuição para o grupo "+contribuicao.getGrupo().getNome()+" foi registrado ");
		...
		public void salvarLancamentoDeOfertas(){
			...
			Utils.mostrarMensagemJsfSucesso("lançamento de dízimo realizado com sucesso");
