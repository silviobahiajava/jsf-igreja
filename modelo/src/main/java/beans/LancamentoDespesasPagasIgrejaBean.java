	...
	public void calcular() {
		...
		public void salvarLancamentoDeDespesaDaIgrejas(){
			...
			try{
			   ...
			   mostrarDespesasPagas();
			Utils.mostrarMensagemJsfSucesso("lançamento de DespesaDaIgrejas realizado com sucesso");
			}catch(RuntimeException e){
				Utils.mostrarMensagemJsfErro("erro ao fazer lançamento de DespesaDaIgrejas");
				e.printStackTrace();
			}
		}
