...
@ManagedBean(name="lancamentoOfertaCriancasBean")
public class LancamentoOfertaCriancasBean {
...
//	private List<Compra>listaComprasLancamento;
	...
	public void listar() {
		try {
			...
			lancamentos=ldao.buscarLancamentoPorCodigo(3L);
