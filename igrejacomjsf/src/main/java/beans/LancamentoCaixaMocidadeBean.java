...
@ManagedBean(name="lancamentoCaxaMocidadeBean")
@ViewScoped
public class LancamentoCaixaMocidadeBean {
...
//	private List<Compra>listaComprasLancamento;
	...
	public void listar() {
		try {
			...
			lancamentos=ldao.buscarLancamentoPorGrupo(5L);
	...
	public void salvar() {
		...
		try {
			LancamentoDao ldao=new LancamentoDao();
			Grupo grupopesquisado=gdao.buscar(5L);
