...
public class ContribuicaoBean {
    ...
    public void verificarGrupo(){
    	...
    	case "Mocidade":
    	{
    		...
    		try {
    			...
    			{
    				Utils.mostrarMensagemJsfSucesso("voce não é tesoureiro da mocidade");
    			}
			} catch (IOException e) {
	...
	public void salvar(){
		try{
			...
			Utils.mostrarMensagemJsfErro("erro ao registrar o dízimo");
		}
	}
	...
	public void excluir(ActionEvent evento) {
		try {
			...
			Utils.mostrarMensagemJsfSucesso("contriuição excluída ou cancelado");
