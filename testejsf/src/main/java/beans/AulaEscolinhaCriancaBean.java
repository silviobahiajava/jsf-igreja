...
private AulaEscolinhaCrianca aula;
	...
	public void definirPresenca(CriancaMatriculadaNaEscolinha matriculado){
		...
		Utils.mostrarMensagemJsfSucesso("o aluno "+alunoPresente.getMatriculado().getCrianca().getNome()+" est� presente");
	...
	public void definirFalta(CriancaMatriculadaNaEscolinha matriculado){
		...
		Utils.mostrarMensagemJsfSucesso("o aluno "+alunoAusente.getMatriculado().getCrianca().getNome()+" est� ausente");
