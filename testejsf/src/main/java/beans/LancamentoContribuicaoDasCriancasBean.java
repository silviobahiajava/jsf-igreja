...
public class LancamentoContribuicaoDasCriancasBean {
	...
	public void calcular() {
		...
		public void adicionarContribuicoes(ActionEvent evento){
			...
			//implementar e exclus�o desta contribui��o da lista de contribui��es apos esta contribuicao ser adicionada na lista de 
			//contribuic��es pra lan�amento
		...
		public void salvarLancamentoDeContribuicoes(){
			...
			try{
				...
				lancamento.setHistorico("contribui��o para o Minist�rio Infantil");
				lancamento.setDespesa(new BigDecimal("0.00"));
			...
			Utils.mostrarMensagemJsfSucesso("contribui��o registrada   com sucesso");
				...
				Utils.mostrarMensagemJsfErro("erro ao fazer esta opera��o");
				e.printStackTrace();
			}
		}
