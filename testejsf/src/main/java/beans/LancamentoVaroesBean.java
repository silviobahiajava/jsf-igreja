...
@ManagedBean(name="lancamentoVaroesBean")
@ViewScoped
public class LancamentoVaroesBean implements Serializable{
...
//	private List<Compra>listaComprasLancamento;
	...
	public void listar() {
		try {
			...
			lancamentos=ldao.buscarLancamentoPorCodigo(codigoGrupo);
